          ...
          <div class="row justify-content-start">
            <div class="col-lg-7">
              <h1 class="display-2 fw-bold mb-4 text-light animated slideInDown">
                <span class="text-primary">Teh</span><span class="text-warning"> Kita</span>Tentang
              </h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">Kesegaran alami dalam setiap tegukan. Es teh kami diracik dari bahan pilihan untuk menghadirkan rasa teh yang otentik dan menyegarkan.</p>
                    ...
                    <a class="btn btn-primary rounded-pill py-3 px-5 mt-3" href="">Baca Terlebih Dahulu</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row g-4">
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="bg-white text-center h-100 p-4 p-xl-5">
            ...
            <p class="mb-4">Kami memilih daun teh organik bebas pestisida dan bahan kimia, diproses secara hati-hati agar cita rasa, aroma, dan kualitas alaminya tetap terjaga.</p>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="contact.php">Konntak</a>
                </div>
